      ...
      >
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <h2 style={{ fontSize: "2.2rem", fontWeight: "900", letterSpacing: "-0.5px" }}>
            Join Learn<span style={{ color: "#00eaff" }}>Flow</span>
          </h2>
          <p style={{ color: "rgba(180, 200, 255, 0.6)", marginTop: "0.5rem" }}>Create your account to start learning</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
          <div className="input-group">
            <label style={{ display: "block", marginBottom: "0.5rem", color: "rgba(200,220,255,0.9)", fontSize: "0.9rem", fontWeight: "600" }}>Name</label>
            <input
              type="text"
              value={name}
        ...
        <p style={{ marginTop: "2rem", textAlign: "center", color: "rgba(180,200,255,0.7)" }}>
          Already have an account? <Link to="/sign-in" style={{ color: "#00eaff", textDecoration: "none", fontWeight: "bold" }}>Sign In</Link>
        </p>
      </div>
    </div>
  );
